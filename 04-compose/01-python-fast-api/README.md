...
Wenn du die API testen möchtest, kannst du das mit dem File test.http machen.
Installiere dazu die Extension "REST Client" in Visual Studio Code und führe die
Anfragen aus.
